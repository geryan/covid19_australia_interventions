...
saveRDS(fitted_model, "outputs/vl_half_ext/fitted_reff_model.RDS")
# # fitted_model <- readRDS("outputs/fitted_reff_model.RDS")
# 
# # output Reff trajectory draws for Rob M
 write_reff_sims(fitted_model, dir = "outputs/vl_half_ext/projection")
# 
...
reff_plotting(fitted_model, dir = "outputs/vl_half_ext")
# 
...
reff_plotting(fitted_model,
              dir = "outputs/vl_half_ext/projection",
