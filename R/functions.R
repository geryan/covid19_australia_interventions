...
location_change <- function(dates = NULL) {
  ...
  google_change_trends <- readRDS("outputs/vl_full_ext/google_change_trends.RDS") 
...
reff_model_data <- function(
  ...
  mobility_data <- readRDS("outputs/vl_full_ext/google_change_trends.RDS")
